...
;**     Date/Time   : 2014-01-28, 14:31, # CodeGen: 0
;**     Abstract    :
...
;** ===================================================================
        XDEF    isrVtpmovf
isrVtpmovf:
        ; Heartbeat LED portion of the interrupt
  	    	MOV     #%11111111,PTBDD            ; configure port B as output
  		    BCLR    7, TPMSC  		            ; 
  		    LDX     counter
  		    BNE     loop 		     
		    LDX	    hbstate
		    BNE     tog1					    ; if the led is on (1) branch to tog1     
		    LDA    #$01
		    STA    hbstate                      ; turn hbstate from 1 to 0
		    LDA    #%00101001                   ; set LEDs to 0, choose the first DFF
		    BRA end_tog
		; turn LED off    
		tog1:
		    LDA    #$00
		    STA    hbstate                      ; turn hbstate from 1 to 0
		    LDA    #%00001001                   ; set LEDs to 0, choose the first DFF
		end_tog:
...
_vect:
        ...
        DC.W    isrVtpmovf             ; Int.no.  7 Vtpmovf (at FFF0)               Unassigned
